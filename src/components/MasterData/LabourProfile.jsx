        ...
        <section className="detail-panel">
            <div className="detail-header">
                <div className="header-content">
                    <h1>{isNewMode ? 'Create New Labour' : `Labour Profile: ${LabourName || 'Labour'}`}</h1>
                    <div className="header-subtitle">
                        <span className="mode-badge">{isNewMode ? 'NEW' : 'EDIT'}</span>
                        <span className="muted">• {LabourCode || 'No Code'}</span>
                    ...
                    <div className="section-content">
                        <div className="form-grid grid-3-col">
                            <div className="form-group required">
                                ...
                                />
                                {isNewMode && (
                                    <div className="hint">Code will be auto-generated as 0000000001, 0000000002, etc.</div>
                                )}
                            </div>
                            ...
                            <div className="form-group checkbox-group">
                                <input
                                    ...
                                    disabled={!canEdit}
                                />
                                <label htmlFor="isActive">Labour is Active</label>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="form-grid grid-3-col">
                            <div className="form-group">
                                ...
                                {labourControlAccount && (
                                    <div className="field-info">Control Account: {labourControlAccount}</div>
                                )}
                            </div>
...
const LabourProfile = () => {
    ...
    const generateLabourCode = useCallback(() => {
        ...
        const existingCodes = labourData
            .map(l => parseInt(normalizeValue(l.LabourCode)))
    ...
    }, [currentMode, currentOffcode, lookupData, generateLabourCode]);
            ...
            <aside className="sidebar">
                <div className="sidebar-top">
                    <div className="sidebar-title">
                        ...
                        <div>
                            <div className="h3">Labour Profiles</div>
                            <div className="muted small">{labourData.length} labours • Office: {currentOffcode}</div>
                        </div>
                    </div>
                ...
                <div className="sidebar-body">
                    {isDataLoading && labourData.length === 0 ? (
                        <div className="loading-message">
                            <Icon.Loader className="spin" /> Loading Labour...
                        </div>
                        ...
                        <div className="profile-list">
                            {filteredLabour.map(labour => (
                                <div
                                    ...
                                    className={`profile-item ${selectedLabour?.LabourCode === labour.LabourCode && currentMode === 'edit' ? 'selected' : ''
                                        }`}
                                    onClick={() => handleSelectLabour(labour)}
                                >
                                    <div className="profile-main">
                                        <div className="code-name">
                                            <span className="code">{normalizeValue(labour.LabourCode)}</span>
                                            <span className="name">{normalizeValue(labour.LabourName)}</span>
                                        </div>
                                        <div className="profile-meta">
                                            {normalizeValue(labour.isactive) === 'true' ? (
                                                <span className="status active">Active</span>
                                            ) : (
                                                <span className="status inactive">Inactive</span>
                                            )}
                                            <span className="labour-type">
                                                {labour.LabourType === '01' && 'Regular'}
                                                {labour.LabourType === '02' && 'Contract'}
                                            </span>
                                        </div>
                                    </div>
                        ...
                        <div className="empty-state">
                            ...
                            <div className="muted">No labour found</div>
                            {searchTerm && (
            ...
            <div className="app-header">
                <div className="header-brand">
                    ...
                    <div>
                        ...
                        <div className="muted">Manage labour profiles</div>
                    </div>
                </div>
            ...
            <div className="toolbar">
                <div className="toolbar-section">
                    ...
                    {hasPermission && hasPermission(menuId, 'add') && (
                        <button className="toolbar-btn" onClick={handleNewLabour}>
                            <Icon.Plus /> New Labour
                        </button>
                    )}
