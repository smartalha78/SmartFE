...
// Add Info icon
Icon.Info = (props) => <svg {...props} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="16" x2="12" y2="12"></line><line x1="12" y1="8" x2="12.01" y2="8"></line></svg>;
...
const useDataService = () => {
 ...
 const loadAllData = useCallback(async () => {
  ...
  try {
    const currentOffcode = credentials?.company?.offcode || '0101'; // default to your actual branch code
    ...
    console.log('Parent Account (calculated):', parentAccount);
    console.log('All Accounts:', allAccountsData);
  ...
  return { lookupData, isLoading, error, refetch: loadAllData };
};
...
---------------------------- */
const ImageUpload = ({ imageUrl, onImageChange, itemCode }) => {
...
---------------------------- */
const ItemTreeNode = ({ node, level = 0, onSelect, selectedItem, searchTerm }) => {
...
const ItemTreeSidebar = ({ items, selectedItem, onItemSelect, searchTerm, onSearchChange, isLoading }) => {
    ...
    <section className="detail-panel">
      <div className="detail-header">
        <div className="header-content">
          <h1>{isNewMode ? 'Create New Item' : 'Item Details'}</h1>
            ...
            <CollapsibleSection title="Basic Information" icon={<Icon.FileText />} defaultExpanded={true}>
              <div className="form-grid compact">
                ...
                <div className="field">
                  ...
                  <select value={ItemType} onChange={e => handleInput('ItemType', e.target.value)}>
                ...
                <div className="field">
                  ...
                  <select value={InvType} onChange={e => handleInput('InvType', e.target.value)}>
                ...
                <div className="field">
                  ...
                  <select value={uom} onChange={e => handleInput('uom', e.target.value)}>
                ...
                <div className="field">
                  ...
                  <select value={typeCategory} onChange={e => handleInput('typeCategory', e.target.value)}>
            ...
            <CollapsibleSection title="Account Mapping" icon={<Icon.Database />} defaultExpanded={false}>
              ...
              <div className="form-grid compact">
                <div className="field">
                  ...
                  <select value={AssetAccount} onChange={e => handleInput('AssetAccount', e.target.value)}>
                ...
                <div className="field">
                  ...
                  <select value={PurchaseReturnAccount} onChange={e => handleInput('PurchaseReturnAccount', e.target.value)}>
                ...
                <div className="field">
                  ...
                  <select value={InputTaxAccount} onChange={e => handleInput('InputTaxAccount', e.target.value)}>
                ...
                <div className="field">
                  ...
                  <select value={IncomeAccount} onChange={e => handleInput('IncomeAccount', e.target.value)}>
                ...
                <div className="field">
                  ...
                  <select value={SalesReturnAccount} onChange={e => handleInput('SalesReturnAccount', e.target.value)}>
                ...
                <div className="field">
                  ...
                  <select value={OutPutTaxAccount} onChange={e => handleInput('OutPutTaxAccount', e.target.value)}>
                ...
                <div className="field">
                  ...
                  <select value={ConsumptionAccount} onChange={e => handleInput('ConsumptionAccount', e.target.value)}>
                ...
                <div className="field">
                  ...
                  <select value={AdjustmentAccount} onChange={e => handleInput('AdjustmentAccount', e.target.value)}>
...
const ItemProfile = ({ initialMode = 'new' }) => {
  ...
  const { lookupData, isLoading: isLookupLoading, error: lookupError, refetch: refetchLookupData } = useDataService();

  const [formData, setFormData] = useState({
    StoreMainType: '1', offcode: currentOffcode, ItemParent: '00', ItemCode: '', ItemName: '',
    ...
    AdjustmentAccount: '', createdby: USER_LOGIN, createdate: new Date().toISOString().split('T')[0] + 'T00:00:00+05:00',
    editby: USER_LOGIN, editdate: new Date().toISOString().split('T')[0] + 'T00:00:00+05:00',
  ...
  const fetchItems = useCallback(async () => {
    ...
    try {
      ...
      if (data.success && Array.isArray(data.rows)) {
        ...
        setItems(normalized);
        setMessage(`✅ Loaded ${normalized.length} items successfully`);
      } else {
  ...
  const setupNewRootItem = () => {
    ...
    setAllFormData({
      StoreMainType: '1', offcode: currentOffcode, ItemParent: '00', ItemCode: newRootCode, ItemName: '',
      ItemType: '1', InvType: '1', uom: '1', nlevel: '1', IsItemLevel: 'false',
      isActive: 'true', isDispatch: 'false', isPurchase: 'true', isManufactur: 'false',
      isConsumeable: 'true', minQty: '0', CriticalQty: '0', ReorderQty: '0',
      pictureURL: '', CostPrice: '0.00', DeliveryTime: '0', SalePrice: '0.00',
  ...
  return (
    <div className="item-profile-page">
